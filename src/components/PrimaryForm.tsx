...
import { InputItem, PostFormInputs } from "@/types";
      ...
      <div className="h-2/3 flex">
        ...
        <div className="ml-2 flex flex-col w-full">
          <input
            type="text"
            {...register("title")}
            placeholder="El titulo aca"
            className="w-full p-2 placeholder:text-lg rounded-xl shadow-md my-2"
          />
          <textarea
            {...register("text")}
            placeholder="Escribe algo acá"
            className="w-full h-48 p-2 placeholder:text-2xl rounded-xl shadow-md my-2 "
          />
        </div>
      </div>
      <div
        className={`border-t-2 p-4 bg-cyan-100 ${
      ...
      >
        <div className=" flex gap-4">
          <div>
            ...
            >
              <FontAwesomeIcon
                className="h-full text-indigo-600 cursor-pointer hover:text-indigo-500 transition-all"
                icon={faCamera}
              />
            </button>
            <input
          ...
          <div>
            ...
            >
              <FontAwesomeIcon
                className={`h-full cursor-pointer hover:text-indigo-500 transition-all ${
                  tagInputVisibility ? "text-indigo-900" : "text-indigo-600"
                } `}
                icon={faTag}
              />
            </button>
